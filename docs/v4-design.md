...
- Release gate (all kinds): once `diff_diff.__version__` reaches a row's
  ...
  unsupported-period policy; previously 126 as of the family-wide
  ...
  results-field mirror M-143 + the anticipation policy row M-144 + the DML review-follow-ups pair M-145/M-146 + the unsupported-period policy M-147;
