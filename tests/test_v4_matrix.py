...
# family-wide summary-alpha guard) = 128; + the ETWFE unsupported-period
# policy (M-147) = 129.
...
def test_initial_ids_never_deleted():
    ...
    Extends as rows ship (129 as of the ETWFE unsupported-period policy:
    ...
    M-136..M-138 + M-139 + M-140..M-142 + M-143 + M-144 + M-145/M-146 + M-147)."""
...
def _changes_at_4_0(row):
    ...
    - 4 ``behavior`` rows with ``introduced_in: 4.0`` and no deprecation/removal
      ...
      ``M-146`` summary-alpha guard, ``M-147`` ETWFE unsupported-period policy
      - the post-cut behavior changes): they land
